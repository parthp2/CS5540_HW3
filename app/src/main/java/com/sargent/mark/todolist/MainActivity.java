...
public class MainActivity extends AppCompatActivity implements AddToDoFragment.OnDialogCloseListener, UpdateToDoFragment.OnUpdateDialogCloseListener,AdapterView.OnItemSelectedListener{
    ...
    //this the Override method for menu

    @Override
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.menu,menu);

        //here we are adding spinner into menu item

        MenuItem item = menu.findItem(R.id.mspinner);
        Spinner spin = (Spinner) MenuItemCompat.getActionView(item);
        spin.setOnItemSelectedListener(this);

        //taking adapter that will take the items from strings array
    ...
    // overriden method of setonSelectedListener it will check the selected menu and based on that show the result
    ...
    //this method perform the database query based on two argument database name and selected category
